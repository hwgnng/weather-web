  ...
  return (
    <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
      <div className="flex items-center space-x-3 mb-8">
        ...
        <h2 className="text-white font-bold text-2xl">5 Day Forecast</h2>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center space-x-5 flex-1">
                <div className="text-white/90 group-hover:text-white transition-all transfrom group=hover:scale-110 duration">
                  {/* Dynamic Icons */}
